...
This explainer targets Agentic Architecture Audit Specification v3.1 (2026-05-08) and Project Profile Discovery Directive v1.2. If it conflicts with the spec, the spec wins.
...
You'll see two authority docs in this folder: the profile directive (`project-profile-directive.md`) and the audit spec (`agentic-audit-spec-v3.md`). The kickoff prompt and this explainer are companion docs derived from those authority texts. Run the profile first. Review what it found. Then run the audit.
...
Spec reference: `agentic-audit-spec-v3.md` (full v3.1 specification, 2026-05-08).
Precursor: `project-profile-directive.md` (v1.2) — run this first to produce the profile snapshot the audit consumes.

...
7. Check directive-set companion metadata if supplied (`audit-kickoff-prompt.md`, `audit-spec-friendly-explainer.md`, manifest, examples). Record drift when companions target a different authority version.
...
1. Run profile discovery directive v1.2 to refresh the profile (it emits diff artifacts, strategic-themes blocks, and protocol/authority/state/provenance baselines).
...
2. Run profile discovery directive v1.2 to refresh protocol, authority, state, provenance, and companion-artifact fields.
